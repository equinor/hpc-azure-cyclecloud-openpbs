...
Our [CycleCloud OpenPBS](https://github.com/equinor/hpc-azure-cyclecloud-openpbs) repository is a fork of [Azure/cyclecloud-pbspro](https://github.com/Azure/cyclecloud-pbspro), and is used in addition to our [main Azure CycleCloud repository](https://github.com/equinor/hpc-azure-cyclecloud)
