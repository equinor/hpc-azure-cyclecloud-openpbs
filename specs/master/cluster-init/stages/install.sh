...
#
# For Equinor, we use the property pbspro.scheduler for the template for the scheduler hostname 
# ... this is picked up in default/files/utils.sh (no code changes needed there)
#
